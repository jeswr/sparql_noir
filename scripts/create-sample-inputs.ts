...
function createProverToml(circuitPath: string, circuitName: string): void {
  ...
  function addTomlValue(key: string, value: any, parentPath: string = ''): void {
...
function createAllSampleInputs(baseDir: string): void {
